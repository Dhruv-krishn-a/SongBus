        ...
        <div className="flex flex-col items-center md:items-end w-full md:w-auto gap-4">
           <div className="flex gap-2 w-full">
             <button 
               onClick={handleAudit}
               disabled={loading}
               className="flex-1 px-6 h-14 bg-gray-900 text-white rounded-2xl font-black shadow-xl hover:bg-gray-800 transition-all flex items-center justify-center gap-2"
             >
             ...
             <button 
               ...
               className="px-6 h-14 bg-primary text-white rounded-2xl font-black shadow-xl hover:bg-blue-600 transition-all flex items-center justify-center gap-2"
               title="Find matching tracks on the destination platform"
             >
           ...
           <p className="text-xs font-bold text-gray-400 text-center md:text-right">
             Audit checks for matches. Build Bridge finds them.
           </p>
        </div>
      </div>
